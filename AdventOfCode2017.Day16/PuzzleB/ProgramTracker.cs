...
namespace AdventOfCode2017.Day16.PuzzleB
{
    public static class ProgramTracker
    {
            ...
            string initialPrograms)
        {
            ...
            List<string> pastIterations = new List<string>()
            {
            ...
            while(!loopFound)
            {
                ...
                if (pastIterations.Any(i => i == programs))
                {
                    loopFound = true;
                }

                pastIterations.Add(string.Copy(programs));
                loopLength++;
            }

            int loopRemainder = 1000000000 % loopLength;

            for (int l = 0; l < loopRemainder; l++)
            {
                foreach (var instruction in instructions)
                {
                    switch (instruction[0])
