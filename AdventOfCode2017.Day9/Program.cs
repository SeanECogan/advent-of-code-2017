...
namespace AdventOfCode2017.Day9
{
    public class Program
    {
        ...
        {
            // Intro message.
            Console.WriteLine("--- Begin Day 9 - Puzzle A ---");
            Console.WriteLine();
            ...
            int result = PuzzleA.StreamProcessor.ScoreGroups(inputStream);
        ...
        {
            // Intro message.
            Console.WriteLine("--- Begin Day 9 - Puzzle B ---");
            Console.WriteLine();
            ...
            int result = PuzzleB.StreamProcessor.CountGarbage(inputStream);
